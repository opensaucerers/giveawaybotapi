...
func main() {
	...
	// err := scraper.Login("opensaucerers", "08070718Sam")
	// if err != nil {
	// 	log.Fatal(err)
	// }
	...
	tw := "1746174367833239826"
	counter := 0
	for tweet := range scraper.SearchTweets(context.Background(), "@opensaucery @opensaucerers", 1800) {
